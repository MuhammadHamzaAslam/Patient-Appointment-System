...
function PatientAppointmentCards({ appointments }) {
  return (
    <div>
      <div>
        <h1 className="text-2xl font-bold mb-6">Your Appointments To These Doctor</h1>
      </div>
...
export default PatientAppointmentCards;
